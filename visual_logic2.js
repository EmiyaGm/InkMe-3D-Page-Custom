...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        isDataUrl, convertObjToJsonDataUrl, convertObjToTextDataUrl, LIST_NONE,
    };
};
...
operateAnimation('PLAY', 'Empty', null, null, 'LoopOnce', 1,
        function() {}, false);
...
eventHTMLElem('click', 'exportmodel', true, function(event) {
  ...
  replaceTexture('susannas_help_PBR', 'yourdesignhere_001.png.001', myDrawer2, function() {});
...
eventHTMLElem('click', 'knitanimation', true, function(event) {
  ...
  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'app.knitting.trigger()')(appInstance, v3d, PL, VARS, PROC);


  operateAnimation('SET_FRAME', 'tshirt_waves', 0, null, 'AUTO', 1,
          function() {}, false);

      replaceTexture('Base', 'outsideaohoodie.jpg', 'outsideaohoodie.jpg', function() {});
});
...
operateAnimation('PAUSE', anims, null, null, 'AUTO', 1,
  ...
  operateAnimation('PLAY', 'tshirt_walking', 0, 15, 'AUTO', 0.3,
          function() {}, false);

      replaceTexture('Base', 'outsideaohoodie.jpg', 'walkingoutsideao.jpg', function() {});
  replaceTexture('Base', 'hoodie_Bake1_CyclesBake_AO.jpg', 'walkingaoinside.jpg', function() {});
  changeVis(tshirts, false);
...
eventHTMLElem('click', 'windanimation', true, function(event) {
  ...
  operateAnimation('PLAY', 'tshirt_waves', 0, 25, 'AUTO', 0.2,
          function() {}, false);

      replaceTexture('Base', 'outsideaohoodie.jpg', 'outsideaohoodie.jpg', function() {});
  replaceTexture('Base', 'hoodie_Bake1_CyclesBake_AO.jpg', 'hoodie_Bake1_CyclesBake_AO.jpg', function() {});
  changeVis(tshirts, false);
...
eventHTMLElem('click', 'walking_mobile', true, function(event) {
...
eventHTMLElem('click', 'wind_mobile', true, function(event) {
...
eventHTMLElem('click', 'garmentnone_mobile', true, function(event) {
...
eventHTMLElem('click', 'knit_mobile', true, function(event) {
...
/* For Mobile user interface */
eventHTMLElem('click', 'rotate_mobile', true, function(event) {
...
eventHTMLElem('click', 'rotatezoom_mobile', true, function(event) {
...
eventHTMLElem('click', 'none_mobile', true, function(event) {
